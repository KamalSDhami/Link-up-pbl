import { AlertCircle, CalendarClock, Clock3, Sparkles } from 'lucide-react'
    ...
    <div className="space-y-8">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-sm" style={{ color: 'var(--text-secondary)' }}>
          The /events/manage workspace is currently under maintenance and redesign.
        </p>
      </header>
      ...
      <section className="rounded-2xl border border-[color:var(--color-border)] bg-[var(--color-surface)] p-8">
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-4 text-center">
          ...
          <h2 className="text-2xl font-display font-semibold" style={{ color: 'var(--text-primary)' }}>
            Event management is coming soon
          </h2>
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
            A new management experience is being prepared with improved controls and reliability.
          </p>
          <div
            className="mt-2 inline-flex items-center gap-2 rounded-full border border-[color:var(--color-border)] bg-[var(--color-bg)] px-4 py-2 text-sm"
